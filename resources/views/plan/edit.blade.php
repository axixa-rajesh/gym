                    ...
                    <form method="POST" action="/plans/{{ $info['id'] }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="duration" id="duration" class="form-control" required
                                value="{{ old('duration') ??  $info['duration'] }}" placeholder="Enter Duration In Months" min="1"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="fees" id="fees" class="form-control" required
                                value="{{ old('fees') ?? $info['fees'] }}" placeholder="Enter Fees In Rupees"
                                title="Enter Valid Fees">
                            @error('fees')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="discount" id="discount" class="form-control"
                                value="{{ old('discount') ?? $info['discount'] }}" placeholder="Enter Discounts"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control" placeholder="Enter Description" rows="4">{{ old('description') ?? $info['description'] }}</textarea>
                        </div>
                        <div class="mb-3">
