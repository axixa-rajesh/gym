            ...
            <div class="col-9" style="border-radius: 6px; border:1px solid #444; box-shadow:1px 1px 5px #000;">
                <div class="card bg-transparent">
                    ...
                    <div class="card-header text-center">
                        ...
                        <span style="color:#f36100">Edit Memeber</span>
                    </div>
                </div>
                ...
                <div class="card-body leave-comment" style="color:#f36100">
                    <form method="POST" action="/members/{{$info['id']}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="dob" id="dob" value="{{ old('dob')??$info['dob'] }}"
                                class="form-control" placeholder="Enter Date of Birth"
                                max="{{ date('Y-m-d', time() - 86400 * 365.25 * 12) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" id="email"
                                value="{{old('email')??$info['email'] }}"class="form-control" placeholder="Enter Email">
                        </div>
                        <div class="mb-3">
                            <label for="height">Height: </label>
                            <input type="text" name="height" id="height" value="{{ old('height')??$info['height'] }}"
                                class="form-control" placeholder="Enter Height" pattern="[3-9]{1}(.)[0-9]{1,2}">

                        </div>
                        <div class="mb-3">
                            <label for="weight">Weight: </label>
                            <input type="text" name="weight" id="weight" value="{{ old('weight')??$info['weight'] }}"
                                class="form-control" placeholder="Enter weight" pattern="[0-9]{0,3}\.{0,1}\d{1,3}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" id="address" class="form-control" placeholder="Enter Address" rows="4">{{ old('address')??$info['address'] }}</textarea>
                        </div>
                        <div class="mb-3">
